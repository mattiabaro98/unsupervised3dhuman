...
from SMPLfitter.src.utils import PointNetFeaturePropagation, PointNetSetAbstraction
...
class point_net_ssg(nn.Module):
    def __init__(
        ...
        self.sa1 = PointNetSetAbstraction(
            npoint=512, radius=0.1, nsample=32, in_channel=in_channel, mlp=[64, 64, 128], group_all=False
        )  # change 0.1
        self.sa2 = PointNetSetAbstraction(
            npoint=128, radius=0.2, nsample=64, in_channel=128 + 3, mlp=[128, 128, 256], group_all=False
        )  # change 0.2
