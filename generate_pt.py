...
parser.add_argument("--num_iters", type=int, default=20, help="num of register iters")
parser.add_argument("--gpu_ids", type=int, default=0, help="choose gpu ids")
parser.add_argument(
    "--restore_path", type=str, default="./pretrained/model_best_pt.pth", help="pretrained point cloud model path"
)
parser.add_argument("--smplmodel_folder", type=str, default="./smpl_models/", help="pretrained Depth model path")
parser.add_argument(
    "--SMPL_downsample", type=str, default="./smpl_models/SMPL_downsample_index.pkl", help="downsampled SMPL"
)
parser.add_argument("--dirs_save", type=str, default="./demo/demo_pt_save/", help="ssave directory")
parser.add_argument(
    "--filename", type=str, default="./demo/demo_pt/poloshort_ATUsquat.000110.obj", help="file for processing"
)
...
smplmodel = smplx.create(opt.smplmodel_folder, model_type="smpl", gender=opt.gender, ext="pkl").to(device)
...
new_opt_vertices, new_opt_joints, new_opt_pose, new_opt_betas, new_opt_cam_t = pointcloudEM(
